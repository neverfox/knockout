describe('Binding dependencies', function() {
    ...
    describe('Observable view models', function() {
        it('Should be able to update bindings (including callbacks) using an observable view model', function() {
            ...
            expect(testNode.childNodes[0].value).toEqual("My prop value");
            ...
            expect(testNode.childNodes[0].value).toEqual("My new prop value");

            // a change to the input value should be written to the new model
            testNode.childNodes[0].value = "some new user-entered value";
            ko.utils.triggerEvent(testNode.childNodes[0], "change");
